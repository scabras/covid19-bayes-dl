...
pdf(file="../jas/preds1.pdf")
p1
dev.off()

pdf(file="../jas/predsmax.pdf")
pmax
dev.off()
```
...
pdf(file="../jas/bayes-preds-spain1.pdf")
pmax
dev.off()
...
pdf(file="../jas/bayes-predsmaxtest.pdf")
pmax
dev.off()
```
...
datsc1=cvirus
datsc1$MD[last.days]=datsc1$MD[min(last.days)]*(1.1)^((0:9))
est.lstm(datsc1)
